...
class IoisModel(Model):
    ...
    def __init__(self
        ...
        ,meanDuration = 20
        ,sdDuration = 5
        ,improvisation = 3 # Parameter 1
        ,patience = 8 # Parameter 2
        ,cBuild = 0.3 # Parameter 3
        ,useThreshold = 0.5 # Parameter 4
        ,useGain = 0.2 # Parameter 5
        ,commThreshold = 0.5 # Parameter 6
        ,commGain = 0.2 # Parameter 7
        ,conNumber = 5 # Parameter 8
        ,conGain = 0.4 # Parameter 9
        ,buildCost = 90 # Parameter 10
        ,decreaseStrength = 0.1 # Parameter 11
        ,decreaseKnowledge = 0.1 # Parameter 12
        ,initialActors = 120 # Parameter 13
